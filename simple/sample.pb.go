...
func extensionToGoStringSample(m github_com_gogo_protobuf_proto.Message) string {
...
var fileDescriptorSample = []byte{
	...
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x09, 0x6e, 0x88, 0x02, 0xff, 0xe2, 0x12, 0x2e, 0xce, 0xcc, 0x2d,
